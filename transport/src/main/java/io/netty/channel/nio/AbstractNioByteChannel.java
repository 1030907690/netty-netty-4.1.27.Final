...
public abstract class AbstractNioByteChannel extends AbstractNioChannel {
    ...
    protected class NioByteUnsafe extends AbstractNioUnsafe {
        ...
        public final void read() {
            ...
            /*这行代码的作用：得到缓存分配器，(4.1.27.Final版本非Android平台)默认情况是：PooledByteBufAllocator实例。我们可以通过设置属性io.netty.allocator.type来改变。
            如果设置io.netty.allocator.type = “pooled”，则缓存分配器就为：UnpooledByteBufAllocator*/
            ...
            try {
                do {
                    ...
                    //2、doReadBytes(byteBuf)将socketChannel数据写入缓存
